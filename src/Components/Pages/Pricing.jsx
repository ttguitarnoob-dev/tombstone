    ...
    return (
        <section>
            ...
            <section>
                ...
                <InfoSection
                    text="One-time visit starting at $50 (standard size). Immediate before and after photos."
                    title="Benches"
                    bgColor="linear-gradient(310deg, rgba(89,58,96,1) 0%, rgba(105,86,107,1) 50%, rgba(126,96,123,1) 100%)"
                />
                ...
                <InfoSection
                    text="I can pick up your prepaid flower order and deliver to your plot.  Pickup, delivery and placement starting at $25.  Check out Bastrop Florist for some great arrangements"
